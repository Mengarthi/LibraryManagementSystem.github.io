...
class data extends db {
    ...
    function addnewuser($name,$pasword,$email,$type){
        ...
        if($this->connection->exec($q)) {
            header("Location:admin_service_dashboard.php?msg=Added new User");
        }
    ...
    function addbook($bookpic, $bookname, $bookdetail, $bookauor, $bookpub, $branch, $bookprice, $bookquantity) {
